...
<body bgcolor="#ffffff">
    ...
    <div class="body-wrap w320" align="center">
        <table class="head-wrap w320 full-width-gmail-android" style="background: black;" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
            <tr class="header">
                <td class="header container" align="center">
                    <div class="content">
                        <span class="brand">
              <a href="#">
                <img src="https://prolipadigital.com.ec/icon1.png" style="width: 200px" alt="">
              </a>
            </span>
                    </div>
                </td>
                        ...
                        <table cellspacing="0">
                            <tr>
                                <td>
                                    <table class="soapbox">
                                        <tr>
                                            <td class="soapbox-title">Datos Actualizados</td>
                                        </tr>
                                    </table>
                                    <table class="body">
                                        <tr>
                                            ...
                                            <td class="body-padded">
                                                <div class="body-title">Mensaje enviado por: Prolipa, (soporte@prolipa.com.ec)</div>
                                                <table class="body-text">
                                                    <tr>
                                                        <td class="body-text-cell">
                                                            <b>Usuario:</b> <?=$_GET['usuario']?>
                                                            <br>
                                                            <b>Contraseña:</b> <?=$_GET['cedula']?> 
                                                        </td>
                                                    </tr>
                                                </table>
                                                <a href="https://prolipadigital.com.ec/PlataformaProlipa/login.php">Ingresa tus datos aqui</a>
                    ...
                    <div class="content footer-lead">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <p>QUITO</p>
                                    <p>Direccion: Av. La Prensa N58-154 y Vaca de Castro</p>
                                    <p>PBX: 02-3976-100</p>
                                    <p>E-mail: soporte@prolipa.com.ec</p>
                                </td>
                                <td>
                                    <p>GUAYAQUIL</p>
                                    <p>Direccion:</p>
                                    <p> Velez 1905 entre Carchi y Tulcan (FRENTE A LA ACADEMIA ALTAMAR)</p>
                                    <p>PBX: 04-2369212</p>
                                    <p>E-mail: ventasguayaquil@grafitext.com.ec</p>
                                </td>
                            </tr>
        ...
        <table class="footer-wrap w320 full-width-gmail-android" bgcolor="#e5e5e5">
            <tr>
              ...
              <a href="http://www.facebook.com/prolipaEC">Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="https://prolipadigital.com.ec/PlataformaProlipa/">Soporte</a>
            </span>
                    </div>
                </td>
                <td></td>
