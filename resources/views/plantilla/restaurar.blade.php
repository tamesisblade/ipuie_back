...
<body
    style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; margin: 0; padding: 0; border: 0;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                    align="left">
                                                                    <div
                                                                        style="border-top-width: 5px; border-top-color: #0E41AE; border-top-style: solid;">
                                                                        <table class="card-body" border="0"
                                                                                    ...
                                                                                    <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                        ...
                                                                                        <div>
                                                                                            <table class="mx-auto"
                                                                                                ...
                                                                                                cellpadding="0"
                                                                                                cellspacing="0"
                                                                                                style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0 auto;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                            align="left">
                                                                                                            <img class=""
                                                                                                                width="100"
                                                                                                                height="100"
                                                                                                                src="https://prolipadigital.com.ec/cir.png"
                                                                                            ...
                                                                                            <table class="table"
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td colspan="2" style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;"
                                                                                                            align="left"
                                                                                                            valign="top">
                                                                                                            Cedula: {{ $cedula }}
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td colspan="2" style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;"
                                                                                                            align="left"
                                                                                                            valign="top">
                                                                                                            Su código de seguridad de acceso temporal: <strong>{{$codigo}}</strong><h4>Copie este código temporal, e ingrese en la sección de su contraseña, luego le solicitará una nueva contraseña </h4><a href="https://plataforma.prolipadigital.com.ec/">Clic aquí para RECUPERAR SU CONTRASEÑA</a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                    ...
                                                    <div class="text-center text-muted" style="color: #636c72;"
                                                        align="center">Para más información escribenos a:</div>
                                                    <div class="text-center text-muted" style="color: #636c72;"
                                                        align="center">soporte@prolipa.com.ec</div>


                                                    <table class="table-unstyled text-muted " border="0" cellpadding="0"
                                                        cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;"
                                                                    align="left">© Prolipa 2020</td>
                                                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;"
                                                                    align="left">
                                                                    <table class="float-right" align="right" border="0"
                                                                        cellpadding="0" cellspacing="0"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; padding-left: 8px; margin: 0;"
                                                                                                    align="left">
                                                                                                    <a href="https://www.facebook.com/prolipaEC/">
                                                                                                    <img class=" "
                                                                                                        width="20"
                                                                                                        height="20"
                                                                                                        src="https://s3.amazonaws.com/lyft.zimride.com/images/emails/social/v2/facebook@2x.png"
