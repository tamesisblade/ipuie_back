        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center form-group">
                    <h3 class="text-themecolor"><i class="mdi mdi-book"></i>Registro Audio</h3>
                </div>
            </div>
            <div class="card card-body">
                ...
                <v-data-table :headers="headers" :items="audios" :search="search" class="elevation-1" :pagination.sync="paginationI">
                    <template v-slot:item.acciones="{item}">
                        <v-btn fab dark small color="indigo" @click="getEditar(item)"><i class="fa fa-pencil"></i></v-btn>
                        <v-btn fab dark small color="pink" @click="getEliminar(item.idaudio)"><i class="fa fa-trash"></i></v-btn>
                    </template>
                </v-data-table>
            </div>
        </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="col col-md-12">
                            <div class="form-group form-horizontal form-material">
                                ...
                                <input type="text" class="form-control form-control-line nombreaudio" v-model="nombreaudio" require>
                            </div>
                        </div>
                        <div class="col col-md-12">
                            <div class="form-group form-horizontal form-material">
                                <label class="">Descripción</label>
                                <input type="text" class="form-control form-control-line descripcionaudio" v-model="descripcionaudio" require>
                            </div>
                        </div>
                        <div class="row col col-md-12">
                            <div class="form-group col col-md-6">
                                <label class="">audio Web</label>
                                <input type="text" class="form-control form-control-line descripcionaudio" v-model="webaudio" require>
                            </div>
                        </div>
                        <div class="row col col-md-12">
                            <div class="form-group  col col-md-6">
                ...
                <div class="card-body">
                    <div class="form-body">
                        ...
                        <div class="col col-md-12">
                            <div class="form-group form-horizontal form-material">
                                <label class="">Nombre</label>
                                <input type="text" class="form-control form-control-line nombreaudio" v-model="idaudioe" hidden>
                                <input type="text" class="form-control form-control-line nombreaudio" v-model="nombreaudioe" require>
                            </div>
                        </div>
                        <div class="col col-md-12">
                            <div class="form-group form-horizontal form-material">
                                <label class="">Descripción</label>
                                <input type="text" class="form-control form-control-line descripcionaudio" v-model="descripcionaudioe" require>
                            </div>
                        </div>
                        <div class="row col col-md-12">
                            <div class="form-group col col-md-6">
                                <label class="">audio Web</label>
                                <input type="text" class="form-control form-control-line descripcionaudio" v-model="webaudioe" require>
                            </div>
                        </div>
                        <div class="row col col-md-12">
                            <div class="form-group  col col-md-6">
...
export default {
    ...
    methods: {
        ...
        getInfo(item) {},
        getEditar(item) {
            this.idaudioe = item.idaudio;
            this.nombreaudioe = item.nombreaudio;
            this.descripcionaudioe = item.descripcionaudio;
            this.webaudioe = item.webaudio;
        ...
        getcaudioSelect() {
            var _this = this;
            axios.get("./Aaudiodigital").then(function (response) {
                _this.caudio = response.data;
            });
        },
        getcexeSelect() {
            var _this = this;
            axios.get("./Aaudioexe").then(function (response) {
        ...
        setguardar() {
            let me = this;
            axios
                .post("./audior/registrar", {
                    nombreaudio: me.nombreaudio,
                    descripcionaudio: me.descripcionaudio,
                    webaudio: me.webaudio,
        ...
        setguardare() {
            ...
            axios
                .post("./audior/update", {
                    idaudio: me.idaudioe,
                    nombreaudio: me.nombreaudioe,
                    descripcionaudio: me.descripcionaudioe,
                    webaudio: me.webaudioe,
